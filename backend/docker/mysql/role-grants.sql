...
GRANT SELECT, INSERT, UPDATE ON `__DB_NAME__`.`tenants` TO 'demeter_api'@'%';
GRANT SELECT, INSERT, UPDATE ON `__DB_NAME__`.`users` TO 'demeter_api'@'%';
GRANT SELECT, INSERT, UPDATE ON `__DB_NAME__`.`auth_sessions` TO 'demeter_api'@'%';
GRANT SELECT, INSERT, UPDATE ON `__DB_NAME__`.`admin_sessions` TO 'demeter_api'@'%';
GRANT SELECT, INSERT ON `__DB_NAME__`.`admin_command_replays` TO 'demeter_api'@'%';
...
GRANT SELECT, DELETE ON `__DB_NAME__`.`admin_sessions` TO 'demeter_maintenance'@'%';
GRANT SELECT, DELETE ON `__DB_NAME__`.`business_command_replays` TO 'demeter_maintenance'@'%';
GRANT SELECT, DELETE ON `__DB_NAME__`.`admin_command_replays` TO 'demeter_maintenance'@'%';
